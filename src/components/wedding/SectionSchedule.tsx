...
const EVENT_CALENDAR_DATE = new Date(2025, 9, 19);
const EVENT_START_AT = new Date("2025-10-19T11:28:00+08:00");
    ...
    >
      ...
      <div className="rounded-3xl border border-border/20 bg-background/100 p-4 w-auto max-w-[45dvh] shadow-sm backdrop-blur">
        <Calendar
          ...
          weekStartsOn={1}
          modifiersClassNames={{
            highlighted: "bg-primary/10 text-primary font-bold rounded-md",
          }}
          disabled={{
